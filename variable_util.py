task_evaluation = {
    ...
    e. Imagery and Sensory Appeal
       -  Haiku traditionally focus on vivid, clear imagery, often drawn from nature. These images should be evocative, creating a picture in the reader’s mind and appealing to the senses.
